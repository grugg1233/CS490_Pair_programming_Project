const TopActors = () => {
    return (
        ...
        <li className="list-row">
            ...
            <div><img className="size-10 rounded-box" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_8Vuq1sLf6EZH1P10ZQ8zwy3c8QFcfysI9Q&s"/></div>
            <div className="list-col-grow">
            <div>Actor1</div>
            <div className="text-xs uppercase font-semibold opacity-60">Top Film</div>
            </div>
